package com.finddreams.baselib.utils.treeUtil;
...
public class TreeViewAdapter extends BaseAdapter {
	...
	public TreeViewAdapter(ArrayList<Element> elements,
			ArrayList<Element> elementsData, LayoutInflater inflater) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.demo_treeview_item, null);
