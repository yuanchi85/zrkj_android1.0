...
public class TuiHuo_Activity extends BaseActivity {
	...
	public class DemoAdapter extends BaseAdapter {
		...
		public View getView(final int i, View view, ViewGroup viewGroup) {
			...
			if (view == null) {
				view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.tuihuo_tbaerl, null);
		...
		class ViewHolder {
			TextView tv1,tv2,tv3,tv4,tv5,tv6,tv7,tv8,tv9,tv11;
